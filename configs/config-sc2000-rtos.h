...
#if defined UART_DISABLE
	#define CONFIG_UARTOFF
#endif

#if defined M10V_EVB
	#define CONFIG_SYS_USIO_CH	(0x01)
#elif defined GRIII_BB
	#define CONFIG_SYS_USIO_CH	(0x03)
#elif defined GRIII
	#define CONFIG_SYS_USIO_CH	(0x00)
#elif defined R03010
	#define CONFIG_SYS_USIO_CH	(0x00)
#else
	#warning UNDEFINED
	#define CONFIG_SYS_USIO_CH	(0x01)	//Use UART channel 1. ricoh cusom for M10V-EVB.
#endif
